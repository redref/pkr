...
def get_parser():
    ...
    stop_parser.set_defaults(func=lambda a: Kard.load_current().docker_cli.stop(a.services))

    # Restart parser
    restart_parser = sub_p.add_parser("restart", help="Restart pkr")
    add_service_argument(restart_parser)

    restart_parser.set_defaults(func=lambda a: Kard.load_current().docker_cli.restart(a.services))
...
def configure_image_parser(parser):
    ...
    build_parser.set_defaults(func=lambda args: Kard.load_current().build(args))
    ...
    push_parser.set_defaults(func=lambda args: Kard.load_current().push_images(args))
    ...
    pull_parser.set_defaults(func=lambda args: Kard.load_current().pull_images(args))
    ...
    purge_parser.set_defaults(func=lambda args: Kard.load_current().purge_images(args))
    ...
    list_parser.set_defaults(func=lambda args: Kard.load_current().list_images(args))
    ...
    download_parser.set_defaults(func=lambda args: Kard.load_current().download_images(args))
    ...
    import_parser.set_defaults(func=lambda args: Kard.load_current().import_images(args))
...
def configure_kard_parser(parser):
    ...
    create_kard_p.set_defaults(func=Kard.create)
